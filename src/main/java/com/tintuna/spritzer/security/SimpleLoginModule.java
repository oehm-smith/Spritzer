package com.tintuna.spritzer.security;

import com.tintuna.spritzer.domain.Customer;
import com.tintuna.spritzer.service.CustomerService;
...
public class SimpleLoginModule implements LoginModule {
    ...
    public boolean login() throws LoginException {
        ...
        try {
            ...
            Customer customer = null;//customerService.findCustomer(username, password);
